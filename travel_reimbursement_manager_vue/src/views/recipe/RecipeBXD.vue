      ...
      <div class="bottom-section">
        ...
        <el-form :model="basicFormData" label-width="100px" label-position="top" :rules="basicRules">
          <div class="inline-group">
            ...
            <el-form-item label="关联申请单" class="width-45" prop="applyType">
          ...
          <div class="inline-group">
            ...
            <el-form-item label="收款帐号" class="width-45" prop="feeDepart">
              <el-select v-model="basicFormData.feeDepart" placeholder="请选择" @focus="fetchApiOptions" class="width-100">
                <el-option
                  v-for="option in departmentList"
                  :key="option.value"
          ...
          <el-form-item label="差旅目的" prop="purpose">
            <el-input v-model="basicFormData.purpose"></el-input>
          </el-form-item>
          <el-form-item label="事由" prop="remark">
            <el-input v-model="basicFormData.remark"></el-input>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
    ...
    <el-card class="common-card" style="margin: 20px 0">
      <div class="bottom-section">
        ...
        <el-form :model="feeFormData" label-width="100px" label-position="top" :rules="feeRules">
          <div class="inline-group">
            <el-form-item label="出发地" class="width-45" prop="applicant">
              <el-input v-model="feeFormData.applicant"></el-input>
            </el-form-item>
            <el-form-item label="目的地" class="width-45" prop="applicant">
              <el-input v-model="feeFormData.applicant"></el-input>
            </el-form-item>
          </div>
          <div class="inline-group">
            <el-form-item label="费用日期" class="width-45" prop="applicant">
              <el-date-picker
                class="width-100"
            ...
            <el-form-item label="费用金额" class="width-45" prop="applicant">
              <el-input-number
                v-model="feeFormData.applicant"

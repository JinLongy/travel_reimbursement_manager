      ...
      <el-card class="common-card" style="margin-top: 20px" v-if="currentTab === 'tab1'">
        ...
        <div v-else>
          ...
          >
            ...
            <el-table-column prop="travelId" label="单号" width="120" align="center"> </el-table-column>
            <el-table-column prop="travelDesc" label="报销金额" width="120" align="center" :formatter="descFormat">
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getTicketList() {
      this.$http
        .get('/ticketList/' + sessionStorage.getItem('uid'))
        .then((res) => {
